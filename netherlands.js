document.addEventListener('DOMContentLoaded', function() {
    ...
    const learningContents = document.querySelectorAll('.tab-content');
    ...
    // Mobile menu toggle
    const mobileToggleNav = document.querySelector('.mobile-toggle');
    const nav = document.querySelector('nav');

    if (mobileToggleNav && nav) {
        mobileToggleNav.addEventListener('click', () => {
            nav.classList.toggle('active');
        });
    }

    // Weekly experiences tabs
    const weekTabs = document.querySelectorAll('#week-tabs .tab-btn');
    const weekContents = document.querySelectorAll('#week-tabs .tab-content');
    ...
    // Intercultural experiences tabs
    const interculturalTabs = document.querySelectorAll('#intercultural-tabs .tab-btn');
    const interculturalContents = document.querySelectorAll('#intercultural-tabs .tab-content');
    
    interculturalTabs.forEach(tab => {
        tab.addEventListener('click', () => {
            // Remove active class from all tabs and contents
            interculturalTabs.forEach(t => t.classList.remove('active'));
            interculturalContents.forEach(c => c.classList.remove('active'));
